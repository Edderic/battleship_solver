module Battleship
  module TableHelper
    ...
    def initialize(hash)
      ...
      @sunken_points = hash.fetch(:sunken_points) { [] }
    ...
    def recreate!
      ...
      @sunken_points.map {|sunken_point| sunken_point.clone}
      @sunken_points.each {|sunken_point| point_at(sunken_point).sink!; sunken_point.table = self}
