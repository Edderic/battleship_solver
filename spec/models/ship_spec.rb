...
describe Battleship::Ship do
  ...
  describe '#occupies_naive_valid_points?' do
    it 'is true when fully_onboard and does not occupy a missed point' do
      ...
      expect(ship_1).to be_occupies_naive_valid_points
      expect(ship_2).to be_occupies_naive_valid_points
    end

    it 'is false when not fully onboard' do
      ship_1 = Battleship::HorizontalShip.new(length: 2)
      ship_2 = Battleship::HorizontalShip.new(length: 2)
      hit_1 = Battleship::Point.new(row: 1, col: 1)
      hit_2 = Battleship::Point.new(row: 2, col: 2)
      ...
      expect(ship_1).not_to be_occupies_naive_valid_points
      expect(ship_2).not_to be_occupies_naive_valid_points
    end

    it 'is false when occupies a missed point' do
    end
  end
